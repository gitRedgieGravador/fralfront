<template>
  <div>
    <div class="text-center">
      ...
      <v-img class="user_image" src="~@/assets/account.png"></v-img>
      <br>
      <p class="name text-left">{{data.name}}</p>
      <v-row class="buttons">
        <v-col cols="6">
          <v-btn block outlined color="success" class="action" @click="edit">
            <v-icon>mdi mdi-pen</v-icon>Edit
          </v-btn>
        </v-col>
        <v-col cols="6">
          <v-btn block outlined color="primary" class="action" @click="logout">
            <v-icon>mdi mdi-logout</v-icon>Logout
          </v-btn>
        </v-col>
      </v-row>
      <div class="ml-12 mt-5 text-left">
